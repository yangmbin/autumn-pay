...
//C# TO JAVA CONVERTER TODO TASK: Lambda expressions and anonymous methods are not converted by C# to Java Converter:
            predicate = t =>
            !t.IsAbstract && !t.IsInterface && t.GetConstructor(Class.EmptyTypes) != null && t.IsDefined(attributeType, false);
        } else {
//C# TO JAVA CONVERTER TODO TASK: Lambda expressions and anonymous methods are not converted by C# to Java Converter:
...
//ORIGINAL LINE: public static bool IsNullableType(this Type type, out Type valueType)
     ...
     * 基本类型集
     */
    public static final java.util.HashSet<Class> BaseTypeSet = new java.util.HashSet<Class>(NumberTypeSet) {
        String.class,Boolean.class,Character.class,Guid.class,java.util.Date.class,TimeSpan.class,DateTimeOffset.class
    };
    ...
    public static boolean IsEnumOrNullableType(Class type) {
        ...
        if (type.getSuperclass() != null && type.getSuperclass() == Enum.class) {
            ...
            if (type.IsValueType && type.IsGenericType) {
                return .class.
                IsAssignableFrom(type.GetGenericTypeDefinition()) && type.GetGenericArguments()[0].getSuperclass() == Enum.class;
            }
            return false;
        }
    }
